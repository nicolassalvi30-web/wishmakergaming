...
<div className="quickCard">
  ...
  {post.body.split('\n').map((line, i) => {
                ...
                if (clean.match(/(Gameplay|Replayability|Graphics \/ Presentation|Presentation|Value|Final Verdict|Who Should Play|Pros|Cons|Compared|What Makes)/i)) return <h2 key={i}>{clean}</h2>;
